...
ResultSet Rs = null,Rs1=null;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pharmacyJava/login.png"))); // NOI18N
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        String Query = "Select * from pharmadb.agenttb where ANAME='"+Uid.getText()+"' and APASSWORD= '"+PasswordTxt.getText()+"'";
      try{
